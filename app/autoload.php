...
if (!file_exists($autoload = VENDORPATH.'autoload.php')) {
    ...
    Olympus\Components\Error\ErrorDebugger::error500('Unable to find composer autoloader.', 'Please use <code>curl -s http://getcomposer.org/installer | php</code> and <code>php composer.phar install</code> command lines from your project folder.', 'File not found');
}
